...
\begin{align}
 \{(\frac{n_j}{n})_{1\leq j \leq \infty}: \frac{n_1}{n} \geq \frac{n_2}{n} \geq ... \geq 0 \text{ und } \sum_{j=1}^{\infty}{n_j} = n\}\\
 \subset
  \{(p_j^{\downarrow})_{1\leq j \leq \infty}: p_1^{\downarrow} \geq p_2^{\downarrow} \geq ... \geq 0 \text{ und } \sum_{j=1}^{\infty}{p_j^{\downarrow}} = 1\} =: \nabla 
\end{align}
