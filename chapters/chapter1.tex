...
\end{Bemerkung}
In Devroyes Publikation \cite{devroye1998universal} spielt die Größen-verzerrte Version von $\mathcal{P}$ eine wichtige Rolle. Die Verteilung ist durch folgendes Sampling festgelegt.
\begin{enumerate}
